...
import { AudioRecorderComponent } from "../features/forms/components/voice-recording/voice-recording.component";
import { RouterOutlet } from "@angular/router";
import { CommonModule, JsonPipe, NgStyle, UpperCasePipe } from "@angular/common";
import { MenuComponent } from "../features/forms/components/menu/menu.component";
...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, AudioRecorderComponent, UpperCasePipe, JsonPipe, NgStyle, ReactiveFormsModule, CommonModule, MenuComponent],
